...
import { useWatchContractEvents, useSyncContractToMongo } from '../smartcontracthooks/useFlappyContractWithMongo'
import { LeaderboardEntry } from '../types'

interface AutoSyncLeaderboardProps {
  defaultEventId?: string
}

const AutoSyncLeaderboard: React.FC<AutoSyncLeaderboardProps> = ({ defaultEventId = 'week-1' }) => {
  ...
  // Watch for contract events and auto-sync
  useWatchContractEvents(selectedEventId)
  
  // Manual sync functionality
  const { syncAllData, isLoading: syncLoading, totalEntries } = useSyncContractToMongo(selectedEventId)
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          {/* Auto-Sync Status */}
          <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-blue-500/30">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
              🔄 Auto-Sync Leaderboard
            </h2>
            <p className="text-lg text-blue-200 mb-4">
              Automatically syncs with smart contract and MongoDB
            </p>
            
            {/* Sync Status */}
            {syncStatus && (
              <div className="bg-white/10 rounded-xl p-4 mb-4 border border-white/20">
                <p className="text-white font-semibold">{syncStatus}</p>
              </div>
            )}
            ...
            <div className="flex justify-center gap-4 mb-4">
              ...
              >
                {syncLoading ? (
                  ...
                  <>
                    🔄 Manual Sync ({totalEntries} entries)
                  </>
                )}
              </button>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6">
          ...
          {leaderboardLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-300 mb-4">Be the first to play and set a record!</p>
              <button
                onClick={handleManualSync}
                disabled={syncLoading}
              ...
              >
                {syncLoading ? 'Syncing...' : 'Sync from Contract'}
              </button>
            </div>
          ) : (
...
export default AutoSyncLeaderboard
